...
module.exports = (sequelize, DataTypes) => {
    ...
    assign_student_courses.associate = function (models) {
        ...
        assign_student_courses.belongsTo(models.students, {as: 'students', foreignKey: 's_id'});
        assign_student_courses.belongsTo(models.courses, {as: 'courses', foreignKey: 'c_id'});
    };
